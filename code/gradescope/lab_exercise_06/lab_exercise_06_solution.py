...
'''
Write a function named "char_not_in_string"
"char_not_in_string" takes one arguments: <string>, a string
"char_not_in_string" should return True if char "a" is not in <string> and False if char "a" is in <string>
