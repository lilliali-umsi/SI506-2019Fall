...
def find_unique_words(str_list):
    ...
    for string in str_list: # <-- Write a "for" statement here.
        ...
        words = string.split() # <-- Write a "split" statement here.
        ...
        for word in words: # <-- Write another "for" statement here.
            ...
            if word not in unique_words: # <-- Write the "if" statement here.

                # Finally, add the word to the list <unique_words>.
                unique_words.append(word) # <-- Write your code here.
