...
def filter_and_sort_strings(str_list,maximum_len=5): # <-- Write the proper arguments here.
    filtered = []
    ...
    # from <str_list>.
    for item in str_list: # <-- Write your "for" statement here.
