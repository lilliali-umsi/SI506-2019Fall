...
# are seperated by commas. Data stored this way is referred to as "comma-delimited" or, more simply,
# "comma-separated." If you have ever heard of a .csv file: csv means "comma-separated values," and
# data in .csv files is stored in a manner very similar to the below list.
...
# use a string function to separate the string wherever there are commas.
...
# the great_wall_list to a new string, in the following format (pay attention to spaces!):
#
...
great_wall_string = great_wall_list[1] + " is in " + great_wall_list[0] # many ways to do this
print(f'\n4: {great_wall_string}')
...
for site in china_unesco_sites:
    info_list = site.split(',')
    if info_list[2] == 'Cultural':
        info_to_print = [info_list[0],info_list[1],info_list[3]]
        unesco_sites.append(' - '.join(info_to_print))
